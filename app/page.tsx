      ...
      <header className="fixed top-0 w-full bg-white border-b border-black/10 z-50">
        <div className="max-w-7xl mx-auto px-8 py-5 flex items-center justify-between">
          ...
          <nav className="hidden md:flex gap-8 text-sm tracking-wide">
            <button onMouseEnter={() => setActiveMenu("women")} onMouseLeave={() => setActiveMenu(null)}>
              WOMEN
            </button>
            <button onMouseEnter={() => setActiveMenu("men")} onMouseLeave={() => setActiveMenu(null)}>
              MEN
            </button>
            <button onMouseEnter={() => setActiveMenu("collection")} onMouseLeave={() => setActiveMenu(null)}>
              COLLECTION
            </button>
          </nav>

          {/* LOGO CENTER */}
          <div className="text-2xl font-serif tracking-[0.25em]">
            {BRAND}
          </div>
